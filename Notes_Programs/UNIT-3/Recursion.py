...
Recursion means a function calling itself directly or indirectly until a base condition is met.

Each recursive call creates a new copy of the function on the call stack.
So a recursive function must always have a base case to stop infinite recursion.
...
Easier to read and implement for tasks like factorial, Fibonacci, tree traversal.
...
# For: MCA Python Programming (BMC301)
# ----------------------------------------------------------
